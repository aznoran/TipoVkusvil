...
namespace TipoVkusvil.DataAccess.Migrations
{
    ...
    [Migration("20240724172201_Adding_ShoppingCart")]
    partial class Adding_ShoppingCart
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TipoVkusvil.DataAccess.Entities.UserEntity", b =>
                {
                    ...
                    b.Property<Guid>("ShopCartEntityShopCartId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ShopCartEntityShopCartId");
            ...
            modelBuilder.Entity("TipoVkusvil.DataAccess.Entities.UserEntity", b =>
                {
                    b.HasOne("TipoVkusvil.DataAccess.Entities.ShopCartEntity", "ShopCartEntity")
                        .WithMany()
                        .HasForeignKey("ShopCartEntityShopCartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ShopCartEntity");
                });
