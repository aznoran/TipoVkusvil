...
namespace TipoVkusvil.DataAccess.Migrations
{
    ...
    [Migration("20240730115639_Adding_Table_CartItemFinished")]
    partial class Adding_Table_CartItemFinished
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TipoVkusvil.DataAccess.Entities.CartItemFinishedEntity", b =>
                {
                    b.Property<Guid>("CartItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TipoVkusvil.DataAccess.Entities.OrderCartEntity", b =>
                {
                    b.Property<Guid>("OrderId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("CartItemFinishedId")
                        .HasColumnType("uuid");

                    b.HasKey("OrderId", "CartItemFinishedId");

                    b.HasIndex("CartItemFinishedId");

                    b.ToTable("OrderCarts");
                });

            modelBuilder.Entity("TipoVkusvil.DataAccess.Entities.OrderEntity", b =>
                {
                    b.Property<Guid>("OrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TipoVkusvil.DataAccess.Entities.OrderCartEntity", b =>
                {
                    b.HasOne("TipoVkusvil.DataAccess.Entities.CartItemFinishedEntity", "CartItem")
                        .WithMany("OrderCarts")
                        .HasForeignKey("CartItemFinishedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TipoVkusvil.DataAccess.Entities.OrderEntity", "Order")
                        .WithMany("OrderCarts")
